...
const TeamMember = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4">
      ...
      <ul className="mt-12 divide-y divide-gray-200 dark:divide-gray-700">
        {members.map((item, idx) => (
          <li key={idx} className="py-5 flex items-start justify-between">
            ...
            <a
              href="javascript:void(0)"
              className="text-sm border rounded-lg px-3 py-2 duration-150 bg-white dark:bg-gray-800 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              Manage
            </a>
          </li>
